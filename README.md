...
- 1 Логотип компании
- 2 Срез
- 3. С помощью карточки KPI не просто показываем доход за текущий месяц, но и сравниваем его с прошлым месяцем. График окрвсился в зеленый цвет, как как доход в текущем месяце привысил доход в предыдущем месяце.
